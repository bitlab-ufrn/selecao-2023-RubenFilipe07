...
const HomeContent = () => (
    <div className='inicio'>
        <div className='apresentacao'>
            ...
            <img src={demo_remover} alt="Demo remover ofensa" />
            <p>Além disso, nossa ferramenta é capaz de detectar palavras com acentos e/ou caracteres especiais que simulam uma letra, garantindo que nenhum comentário inapropriado passe despercebido.</p>
            <img src={demo_caracteres} alt="Demo caracteres especiais" />
